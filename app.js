    ...
    div.innerHTML = `
            <div class="card lg:h-[500px] bg-base-100 shadow-xl">
                <figure class="px-5 pt-5">
                    <img src="${latestItem.cover_image}" class="rounded-xl bg-[#12132D0D" />
                </figure>
                <div class="card-body ">
                    ...
                    <div class="card-actions">
                      <div>
                        <img class="w-10 h-10 rounded-s-full" src="${ latestItem.profile_image}" alt="">
                        </div>
                        <div>
     ...
     <div  class="lg:flex mt-5 justify-between  gap-5" tabindex="-1">
        <div class="hero shadow-xl rounded-lg  bg-[#797DFC1A]">
            ...
            <div class="avatar -mt-44 indicator">
                    <span class="indicator-item badge ${items.isActive ? "bg-red-600" : "bg-green-400"}">
                    </span>
                    <div class="w-10 h-10 rounded-lg">
                        <img alt="Tailwind CSS examples" src="${items.image}"/>
                    </div>
              </div>
                  ...
                  <div>
                        ...
                        <div class="flex justify-between">
                            ...
                            <div class="-mt-1 w-2/6 lg:w-96 ml-5 lg:ml-36">
                                <button onclick="handleAddInfo('${items.title}', '${items.view_count}')" class="btn bg-[#10B981] btn-sm btn-circle"><i class="fa-regular fa-envelope-open"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
